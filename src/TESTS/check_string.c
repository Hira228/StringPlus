...
//                 "6 - Failed");
//   ck_assert_msg(res7 == NULL, "7 - Failed");
//   free(res1);
//   free(res2);
//   free(res3);
//   free(res4);
...
//   char *res15 = s21_insert(s1, s13, 9);
//   char *res16 = s21_insert(s13, s1, 0);
...
//   ck_assert_msg(res15 == NULL, "15 - Failed");
//   ck_assert_msg(!strcmp(res16, "SCHOOL_21"), "16 - Failed");
//   free(res1);
//   free(res2);
//   free(res3);
//   free(res4);
...
//                 "16 - Failed");
//   ck_assert_msg(res17 == NULL, "17 - Failed");
